  ...
  <div class="goods" v-if="shopInfo">
    ...
    <div class="recommend" v-for="(recommend,index) in shopInfo.recommend" :key="index">
      ...
      <div class="recommend-wrap">
        <ul>
          <li v-for="(item,index2) in recommend.items" :key="index2">
      ...
      <div class="foods-wrapper" ref="foodScroll">
        <ul>
          <li class="food-list-hook" v-for="(item,index) in shopInfo.menu" :key="index">
            ...
            <!-- 内容下 -->
            <div class="fooddetails" v-for="(food,ind) in item.foods" :key="ind" @click="handleFood(food)">
              <!-- 左边 -->
    ...
    <!-- 商品详情 -->
    <Food :isShow="showFood" :food="selectedFood" @close="showFood=false"/>
  </div>
</template>
